...
loginForm.addEventListener("submit", async (e) => {
  ...
  const emailVal = document.getElementById("email_input").value;
  ...
  try {
    ...
    try {
      ...
      console.error("Resposta do PHP:", text);
      throw new Error("O PHP não devolveu um JSON válido (verifica a consola F12).");
    }
